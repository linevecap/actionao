...
Happy domestic create flow
    ...
    Start New Onboarding    buyerdev    xGk<6Of    Test Automation article 15/8    Meeki BV    10000    10    Season    Halloween    2023    augustus    100    12
...
Happy direct import create flow
    ...
    Check Quotation DI create flow    tree.jpg    Test Automation DI article 15/8    English Test Automation DI article 15/8    BANATOYS CO.,LIMITED    10000    10    China    2836200000    12    14    Bombay    Test Automation RuleZ!    10    10    10    23-08-2023    50    10    10    10    5
...
Regression test repeat domestic QAS
    Start New Onboarding repeat flow QAS    buyer1@action.nl    9nT\[7cV    3207246    Petgear Commerciele Dienst B.V.    1000    1,4820    augustus   
...
Nas Create Flow Domestic
    Start Onboarding NAS Create    buyerdev    xGk<6Of    Meeki BV    Test Automation 14/8    10000    10    Stocklots    augustus    100    6 
...
NAS Repeat Flow Domestic
    Start Onboarding NAS Repeat    buyerdev    xGk<6Of    Meeki BV    10000    10    2023    augustus    100    6      10    10    10    10    10    10    10    10    10    10    10    10    10    21,00    21,00    21,00    19,00    20,00    16,00    20,00    23,00    21,00    22,00    21,00    19,00    23,00 
...
Nas Create Flow Domestic QAS
    Start Onboarding NAS Create QAS    buyer1@action.nl    9nT\[7cV    Kapimex B.V.    Test Automation 11/8    10000    10    Stocklots    augustus    100    6 
    # Supplier Enrichment NAS Create    contact@supplier1.abc    s3O$M@|    Test Automation RuleZ!    1    LTR    Germany    Testnr    19-09-2023
...
NAS Create Flow Direct Import
    ...
    # Supplier Enrichment NAS Create    sourcingagentdev    5lC(i)R@=9g?    Test Automation RuleZ!    1    LTR    Germany    Testnr    19-08-2023
    # Buying Enrichment NAS create flow    10    10    10    10    10    10    10    10    10    10    10    10    10    21,00    21,00    21,00    19,00    20,00    16,00    20,00    23,00    21,00    22,00    21,00    19,00    23,00
