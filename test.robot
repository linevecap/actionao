...
Happy domestic create flow
    ...
    Start New Onboarding    buyerdev    xGk<6Of    Test Automation article 19/6    Meeki BV    10000    10    Season    Halloween    2023    juni    100    12
    ...
    Buying Enrichment    buyerdev    xGk<6Of    2    4    6    8    10    12    11    9    7    5    5
...
Happy domestic repeat flow
    ...
    Start New Onboarding repeat flow    buyerdev    xGk<6Of    2568955    Meeki BV    10000    10    2023    juni   
    Supplier Enrichment 1 repeat flow    supplier1dev    E~K5fKT    No    Test Automation RuleZ!    Testnr    26-06-2023    No    Food    Fish    100    ASC        
    Buying Enrichment repeat flow    buyerdev    xGk<6Of
...
Regression test create domestic QAS
    ...
    Buying Enrichment QAS    buyer1@action.nl    9nT\[7cV    5,99    5,99    5,99    5,99    5,99    5,99    5,99    5,99    5,99    5,99
...
Nas Create Flow Domestic
    Start Onboarding NAS Create    buyerdev    xGk<6Of    Meeki BV    Test Automation 19/6    10000    10    Stocklots    juli    100    12 
