...
Happy domestic create flow
    ...
    Start New Onboarding    buyerdev    xGk<6Of    Test Automation article 14/7    Meeki BV    10000    10    Season    Halloween    2023    juli    100    12
    Supplier Enrichment 1    supplier1dev    E~K5fKT    No    Test Automation RuleZ!    10    7    5    5    5    1    LTR    China    Testnr    26-07-2023    Natural fabric    Cotton    100    Not Applicable
    Buying Enrichment    ba1dev    kG\)\(q9>    2    4    6    8    10    12    11    9    10    10    7    5    5
...
Happy domestic repeat flow
    ...
    Supplier Enrichment 1 repeat flow    supplier1dev    E~K5fKT    No    Test Automation RuleZ!    Testnr    26-07-2023    No    40    2,4    10    15    20    400    190    Food    Fish    100    ASC        
...
Happy direct import create flow
    ...
    Check Quotation DI create flow    tree.jpg    Test Automation DI article 18/7    PLAYGO TOYS ENTERPRISES LTD.    150000    10    China    2836200000    12    14    Bombay    Test Automation RuleZ!    10    10    10    23-07-2023    50    10    10    10    5
...
Nas Create Flow Domestic
    Start Onboarding NAS Create    buyerdev    xGk<6Of    Meeki BV    Test Automation 18/7    10000    10    Stocklots    juli    100    6 
